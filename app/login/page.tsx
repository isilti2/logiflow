    ...
    <div className="min-h-screen flex bg-gray-50">
        ...
        <div className="relative space-y-8">
          ...
          <div className="relative">
            ...
            <div className="bg-white/[0.03] border border-white/[0.07] rounded-2xl p-4 space-y-3">
              ...
              <div className="flex items-center justify-between">
                <p className="text-xs font-semibold text-gray-400 dark:text-gray-500">Bu Ay</p>
          ...
          <div className="flex flex-wrap gap-3">
            {['🔒 KVKK Uyumlu', '⚡ <1sn Hesaplama', '🌍 Türkiye\'de Barındırılıyor'].map(t => (
              <span key={t} className="text-xs text-gray-600 dark:text-gray-300 bg-white/[0.03] border border-white/[0.06] px-3 py-1.5 rounded-full">{t}</span>
            ))}
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-white dark:bg-gray-950">
        <div className="w-full max-w-[380px]">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight">Tekrar hoş geldiniz</h1>
            <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 text-sm mt-2">Hesabınıza giriş yapın ve devam edin.</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit} noValidate>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl text-sm text-gray-900 dark:text-white placeholder-gray-300 dark:placeholder-gray-600 bg-gray-50/50 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-400 transition-all"
              />
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                <label htmlFor="password" className="text-sm font-semibold text-gray-700 dark:text-gray-200">Şifre</label>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-11 border border-gray-200 dark:border-gray-700 rounded-xl text-sm text-gray-900 dark:text-white placeholder-gray-300 dark:placeholder-gray-600 bg-gray-50/50 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-400 transition-all"
                />
                <button
                  type="button"
          ...
          {/* Alt güven */}
          <div className="mt-10 pt-6 border-t border-gray-100 dark:border-gray-800 flex items-center justify-center gap-1.5 text-xs text-gray-400 dark:text-gray-500">
