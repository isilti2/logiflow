            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div className="flex h-64">
                  {/* Sidebar */}
                  <div className="w-36 border-r border-gray-100 bg-gray-50 p-3 flex flex-col gap-2 shrink-0">
                  ...
                  <div className="flex-1 p-3 flex flex-col gap-2 overflow-hidden">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="ml-auto h-6 w-20 bg-gray-100 rounded-lg" />
                    </div>
                    ...
                    <div className="grid grid-cols-4 gap-1.5 px-1">
                      {['Kargo ID', 'Tür', 'Ağırlık', 'Durum'].map((col) => (
                        <div
                          key={col}
                          className="h-5 bg-gray-200 rounded text-xs font-semibold text-gray-500 flex items-center px-1.5"
                        >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featureCards.map(({ icon: Icon, title, description }) => (
              <div
                key={title}
                className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col gap-4 hover:shadow-md hover:border-blue-200 transition-all duration-200"
              >
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 to-blue-700">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 mt-2">
            <Link
              href="/depolama"
              className="inline-flex items-center gap-2 bg-white hover:bg-gray-50 text-blue-700 font-bold px-8 py-3.5 rounded-xl transition-colors shadow-lg shadow-blue-800/20"
            >
              Uygulamaya Git
              <ArrowRight size={18} />
            </Link>
