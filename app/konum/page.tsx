      ...
      <header className="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 sticky top-0 z-40">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold text-gray-700 dark:text-gray-200 hidden sm:block flex items-center gap-1.5">
          ...
          <div className="flex items-center gap-2">
            <button onClick={canliYukle} disabled={yukluyor}
              ...
              className="flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500 hover:text-blue-600 border border-gray-200 dark:border-gray-700 px-3 py-2 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-6 flex-1 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-black text-gray-900 dark:text-white">{canliSoforler.length}</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Aktif Şoför</p>
            </div>
          </div>
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-black text-gray-900 dark:text-white">{seferler.filter(s => s.durum === 'devam').length}</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Devam Eden Sefer</p>
            </div>
          </div>
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Ort. Hız (km/s)</p>
            </div>
          </div>
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-4 flex items-center gap-3">
            <div className="w-9 h-9 bg-gray-100 dark:bg-gray-800 rounded-xl flex items-center justify-center shrink-0">
              <Clock className="w-5 h-5 text-gray-500 dark:text-gray-400 dark:text-gray-500" />
            </div>
            <div>
              <p className="text-sm font-bold text-gray-900 dark:text-white">{sonYenileme || '—'}</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Son güncelleme</p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-1 flex flex-col gap-3">
            <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden flex flex-col">
              <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-800">
                <h3 className="font-bold text-gray-900 dark:text-white text-sm flex items-center gap-2">
                  <Users className="w-4 h-4 text-gray-400 dark:text-gray-500" /> Aktif Şoförler
                </h3>
              </div>
              <div className="divide-y divide-gray-50 dark:divide-gray-800 overflow-y-auto flex-1">
                ...
                {canliSoforler.map(s => (
                  <div key={s.id} className="px-4 py-3">
                    ...
                    {s.sefer && (
                      <p className="text-xs text-gray-400 dark:text-gray-500 ml-4 mb-1">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-4">
              ...
              <select value={seciliSefer} onChange={e => setSeciliSefer(e.target.value)}
                className="w-full text-sm border border-gray-200 dark:border-gray-700 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
              ...
              {rota.length > 0 && (
                <p className="text-xs text-gray-400 dark:text-gray-500 mt-2">{rota.length} konum noktası</p>
              )}
            </div>
          </div>

          {/* Harita */}
          <div className="lg:col-span-3 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden" style={{ minHeight: '480px' }}>
            <RouteMap
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-4 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-gray-900 dark:text-white">Şoförler Nasıl Bağlanır?</p>
